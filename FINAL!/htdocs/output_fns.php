    ...
    foreach ($item_array as $row) {
      ...
      if (@file_exists("images/".$row['item_num'].".jpg")) {
        $title = "<img src=\"images/".$row['item_num'].".jpg\"
                  style=\"border: 1px solid black\" width=\"320\" width=\"320\"/>";
...
?>
  ...
  <tr>
    <td>Customer Name</td>
    <td><input type="text" name="CO_name" value="" maxlength="40" size="40"/></td>
  </tr>
  <tr>
    <td>Address</td>
...
<!-- removing Country field as it is not needed and not part of the dabase
    <td>Country</td>
...
<!--- removing Country field as it is not needed and not part of the database  <tr>
    <td>Country</td>
