...
<body>
  ...
  <tr bgcolor="#15384E">
    <td align="left"><img src="logo.jpg" alt="TLA logo" height="70" width="70"></td>
    <td>
        <h1>Dunder Mifflin Paper Products</h1>
    </td>
    <td align="right"><img src="logo.jpg" alt="TLA logo" height="70" width="70" /></td>
  </tr>
  </table>
...
<!-- Label and link to Home -->
  ...
  <tr bgcolor="#15384E">
    <td width="20%" href="home.php" style="cursor:pointer">
      <a href="home.php">
      <img src="s-logo.png" alt="" height="20" width="20" />
      <span class="menu">Home</span></a></td>

<!-- Label and link to Orderform.php -->
    <td width="20%" href="orderform.php" style="cursor:pointer">
      <a href="orderform.php">
      <img src="s-logo.png" alt="" height="20" width="20" />
      <span class="menu">Products</span></a></td>

<!-- Label and link to login.php -->
<td width="20%" href="login.php" style="cursor:pointer">
      <a href="login.php">
      <img src="s-logo.png" alt="" height="20" width="10" />
      <span class="menu">Login</span></a></td>

<!-- Label and link to logout.php -->
<td width="20%" href="logout.php" style="cursor:pointer">
      <a href="logout.php">
      <img src="s-logo.png" alt="" height="20" width="10" />
      <span class="menu">Logout</span></a></td>

<!-- Label and link to Shopping Cart -->
<td width="20%" href="show_cart.php" style="cursor:pointer">
    <a href="show_cart.php">
      <img src="s-logo.png" alt="" height="20" width="20" />
      <span class="menu">Shopping Cart</span></a>
